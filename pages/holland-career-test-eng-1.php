                    ...
                    <div class="form-group">
                        <div class="form-check form-check-inline">
                            <label class="form-check-label" for="'.$data[$i][1].'_1">
                                <input class="joyful" type="radio" name="'.$data[$i][1].'" id="'.$data[$i][1].'_1" value="5"  required="required">
                        ...
                        <div class="form-check form-check-inline">                            
                            <label class="form-check-label" for="'.$data[$i][1].'_2">
                                <input class="happy" type="radio" name="'.$data[$i][1].'" id="'.$data[$i][1].'_2" value="4">
                        ...
                        <div class="form-check form-check-inline">                            
                            <label class="form-check-label" for="'.$data[$i][1].'_4">
                                <input class="bore" type="radio" name="'.$data[$i][1].'" id="'.$data[$i][1].'_4" value="2">
                        ...
                        <div class="form-check form-check-inline">
                            <label class="form-check-label" for="'.$data[$i][1].'_5">
                                <input class="dull" type="radio" name="'.$data[$i][1].'" id="'.$data[$i][1].'_5" value="1">
